/* ============================================================================
   ...
   glowing gold pin, and arc an animated trade-route line from the Bangladesh
   hub (the country flagged hub:true) out to each destination market. Add a
   country in Admin → Countries and it appears here on reload.
   ========================================================================== */
...
window.initMarketsMap = function initMarketsMap() {
  ...
  if (!countries.length) {
    countries = [
      { name: "Bangladesh", lat: 23.68, lng: 90.36, hub: true },
      { name: "UAE", lat: 25.20, lng: 55.27 },
