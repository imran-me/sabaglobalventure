...
window.initProducts = function initProducts() {
  ...
  const ICONS = {
    ...
    /* milk bottle — dairy line */
    "Dairy":           `<g stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 3.5h5M10 3.6V6c0 .6-.25 1.15-.72 1.55C8.05 8.7 8 10 8 11.6v5.9A2.5 2.5 0 0 0 10.5 20h3a2.5 2.5 0 0 0 2.5-2.5v-5.9c0-1.6-.05-2.9-1.28-4.05C14.25 7.15 14 6.6 14 6V3.6"/><path d="M8 12h8" stroke-opacity=".85"/></g>`,
    /* bowl of nuts / dry fruits */
    "Dry Fruits & Nuts":`<g stroke-linecap="round" stroke-linejoin="round"><path d="M4 11.5h16a8 8 0 0 1-16 0Z"/><path d="M12 11.4c-.2-2.4 1.2-4.5 3.4-5.6" stroke-opacity=".8"/><circle cx="9" cy="8.2" r="1.7"/><circle cx="13.4" cy="7.4" r="1.5"/></g>`,
    /* chocolate bar — confectionery */
    "Confectionery":   `<g stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4.8" width="12" height="14.4" rx="1.2"/><path d="M6 9.6h12M6 14.4h12M12 4.8v14.4" stroke-opacity=".85"/></g>`,
  };
